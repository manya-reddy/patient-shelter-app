...
public class PlaceVaccineOrderJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, -1, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel3.setText("Manufacturer Name:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 300, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel4.setText("Quantity:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 350, -1, -1));
        ...
        add(txtVaccineName, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 250, 129, -1));

        txtQty.setBackground(new java.awt.Color(214, 229, 244));
        add(txtQty, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 340, 129, -1));
        ...
        add(cmbVaccineManufacturer, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 290, -1, -1));

        btnSubmit.setBackground(new java.awt.Color(0, 0, 0));
        btnSubmit.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnSubmit.setForeground(new java.awt.Color(255, 255, 255));
        btnSubmit.setText("Order Vaccine");
        btnSubmit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSubmitActionPerformed(evt);
            }
        });
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 410, -1, -1));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, -1, -1));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 120, 60, 60));
    ...
    private void populateComboBox() {
        ...
        for (Enterprise e : city.getEnterpriseDirectory().getEnterpriseArrayList()) {
            ...
            if((e.getClass().getName()).equals("Business.Enterprise.VaccineProvider"))
