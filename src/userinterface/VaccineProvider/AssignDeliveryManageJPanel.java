 ...
 * @author Nishigandha
 */
public class AssignDeliveryManageJPanel extends javax.swing.JPanel {
    ...
    City city;
    Order order;
    public AssignDeliveryManageJPanel(JPanel userProcessContainer, City city, UserAccount userAccount, Organization organization, 
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 270, 550, 160));

        btnAssignOrder.setBackground(new java.awt.Color(0, 0, 0));
        btnAssignOrder.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        add(btnAssignOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 460, -1, -1));

        btnRefresh1.setFont(new java.awt.Font("Tahoma", 3, 10)); // NOI18N
        btnRefresh1.setText("REFRESH TABLES");
        btnRefresh1.setBorder(new javax.swing.border.MatteBorder(null));
        btnRefresh1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRefresh1ActionPerformed(evt);
            }
        });
        add(btnRefresh1, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 200, 160, 25));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, -1, -1));
        ...
        add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 450, -1, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("ASSIGN DELIVERY");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 530, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/icons8-delivery-48.png"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 180, -1, -1));
